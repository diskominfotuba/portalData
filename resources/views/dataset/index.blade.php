...
@section('content')
    ...
    <section class="hero text-center text-white bg-portal-primary py-5">
        <div class="container">
            ...
            <div class="buttons">
                ...
                <button class="btn btn-light text-success fw-semibold" data-bs-toggle="modal"
    ...
    <section class="filters py-5 bg-light">
        <div class="container">
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-12 col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="searchDataset"
            ...
            <!-- Dataset List -->
            <div class="mt-5" id="datasetList"></div>
...
<div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center p-4">
            ...
            <p class="mt-3">
                Halo wargi Tulang Bawang, mohon maaf saat ini tim layanan data sedang menindaklanjuti 12 permohonan
                dataset.
            </p>
            <p>
            ...
            <div class="d-flex justify-content-center gap-3 mt-4">
                <button class="btn btn-success" data-bs-dismiss="modal" data-bs-toggle="modal"
                    data-bs-target="#requestFormModal">Ajukan Permohonan</button>
