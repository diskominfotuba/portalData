...
@section('content')
    <section class="bg-portal-primary text-white py-5">
        <div class="container">
            <h1 class="text-center mb-4 display-5 mt-5 fw-bold">Organisasi</h1>
            <p class="text-center lead">Temukan daftar organisasi yang berkontribusi dalam publikasi data di Open Data
                Tulang Bawang.</p>
        </div>
    </section>
    <div class="container mt-5 pt-5 pb-4">
        ...
        <p class="mb-4">
            Dapatkan daftar Perangkat Daerah (PD) yang berkontribusi dalam membangun ekosistem data yang terbuka dan
            terpercaya melalui publikasi data di Open Data Tulang Bawang.
        </p>

        <!-- Pencarian dan Filter -->
        <div class="row align-items-center mb-4">
            <div class="col-md-8 mb-2">
                <input type="text" class="form-control form-control-lg" placeholder="🔍 Cari organisasi" name="search"
                    id="searchOrganisasi">
            </div>
