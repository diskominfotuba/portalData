  ...
  <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionMenu">
    <div class="accordion-body">
      <ul class="list-unstyled">
        <li><a href="{{ url('/bantuan') }}" class="text-decoration-none text-dark">📖 Apa itu Open Data</a></li>
        <li><a href="{{ url('/bantuan') }}" class="text-decoration-none text-dark">⚙️ Mekanisme Pengumpulan Data</a></li>
      </ul>
    </div>
  </div>
</div>
